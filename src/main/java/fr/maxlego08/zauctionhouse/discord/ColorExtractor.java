...
public class ColorExtractor {
   ...
   private void loadCache() {
      if (this.cacheFile.exists()) {
         try {
            ...
            try {
               Map<String, String> var2 = GSON.fromJson(var1, MAP_TYPE);
               if (var2 != null) {
   ...
   public String getColorForMaterial(String var1, String var2) {
      if (var1 != null && !var1.isEmpty()) {
         String var3 = this.colorCache.get(var1);
         if (var3 != null) {
            return var3;
         } else {
   ...
   private String extractColorFromUrl(String var1) {
      if (var1 != null && !var1.isEmpty()) {
         try {
            ...
            HttpResponse<byte[]> var3 = this.httpClient.send(var2, BodyHandlers.ofByteArray());
            if (var3.statusCode() != 200) {
               return this.defaultColor;
            } else {
               BufferedImage var4 = ImageIO.read(new ByteArrayInputStream(var3.body()));
   ...
   private String calculateDominantColor(BufferedImage var1) {
      ...
      if (var2.isEmpty()) {
         ...
         int var11 = var2.entrySet().stream().max(Entry.comparingByValue()).map(Map.Entry::getKey).orElse(16777215);
