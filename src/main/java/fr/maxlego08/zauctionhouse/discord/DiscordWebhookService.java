...
public class DiscordWebhookService {
   ...
   public CompletableFuture<Void> notifyItemSold(Player var1, AuctionItem var2) {
      if (!this.isEnabled()) {
         ...
         return !var3.isValid() ? CompletableFuture.completedFuture((Object)null) : this.sendWebhook(var3, var2, var1, (Player)null);
      }
   }
   ...
   public CompletableFuture<Void> notifyItemPurchased(Player var1, AuctionItem var2) {
      if (!this.isEnabled()) {
         ...
         return !var3.isValid() ? CompletableFuture.completedFuture((Object)null) : this.sendWebhook(var3, var2, (Player)null, var1);
      }
   }
      ...
      return CompletableFuture.runAsync(() -> {
         try {
            ...
            if (var8.statusCode() >= 400) {
               ...
               var10000.warning("Discord webhook failed with status " + var10001 + ": " + (String)var8.body());
            }
