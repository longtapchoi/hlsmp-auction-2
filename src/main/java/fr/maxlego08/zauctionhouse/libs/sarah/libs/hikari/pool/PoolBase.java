...
abstract class PoolBase {
   ...
   PoolEntry newPoolEntry() throws java.sql.SQLException, ConnectionSetupException {
      return new PoolEntry(this.newConnection(), this, this.isReadOnly, this.isAutoCommit);
   }

   void resetConnectionState(Connection var1, ProxyConnection var2, int var3) throws java.sql.SQLException {
      int var4 = 0;
   ...
   void shutdownNetworkTimeoutExecutor() throws java.sql.SQLException {
   ...
   private void initializeDataSource() throws java.sql.SQLException, PoolBase.ConnectionSetupException {
   ...
   private Connection newConnection() throws java.sql.SQLException, ConnectionSetupException {
   ...
   private void setupConnection(Connection var1) throws ConnectionSetupException, java.sql.SQLException {
      try {
   ...
   private void checkDriverSupport(Connection var1) throws java.sql.SQLException {
   ...
   private void checkValidationSupport(Connection var1) throws java.sql.SQLException {
      try {
         if (this.isUseJdbc4Validation) {
            var1.isValid(1);
         } else {
   ...
   private void checkDefaultIsolation(Connection var1) throws java.sql.SQLException {
      try {
   ...
   private int getAndSetNetworkTimeout(Connection var1, long var2) throws java.sql.SQLException {
   ...
   private void setNetworkTimeout(Connection var1, long var2) throws java.sql.SQLException {
      if (this.isNetworkTimeoutSupported == 1) {
         var1.setNetworkTimeout(this.netTimeoutExecutor, (int)var2);
      }
   ...
   private void executeSql(Connection var1, String var2, boolean var3) throws java.sql.SQLException {
      if (var2 != null) {
   ...
   static class MetricsTrackerDelegate implements IMetricsTrackerDelegate {
      ...
      public void recordConnectionTimeout() throws java.sql.SQLException {
