...
public final class HikariPool extends PoolBase implements HikariPoolMXBean, ConcurrentBag.IBagStateListener {
   ...
   public HikariPool(HikariConfig var1) throws java.sql.SQLException, InterruptedException {
      super(var1);
   ...
   public Connection getConnection(long var1) throws SQLException {
   ...
   public synchronized void shutdown() throws InterruptedException, java.sql.SQLException {
      try {
         this.poolState = 2;
         if (this.addConnectionExecutor != null) {
            ...
            try { this.addConnectionExecutor.awaitTermination(this.getLoginTimeout(), TimeUnit.SECONDS); } catch (InterruptedException e) { Thread.currentThread().interrupt(); }
            ...
            try {
               ...
               var1.shutdown();
               try { var1.awaitTermination(10L, TimeUnit.SECONDS); } catch (InterruptedException e) { Thread.currentThread().interrupt(); }
            }

            this.shutdownNetworkTimeoutExecutor();
            this.closeConnectionExecutor.shutdown();
            try { this.closeConnectionExecutor.awaitTermination(10L, TimeUnit.SECONDS); } catch (InterruptedException e) { Thread.currentThread().interrupt(); }
            return;
         }
      } finally {
   ...
   public void setHealthCheckRegistry(Object var1) {
      // HealthCheckRegistry not available
   }
   ...
   void closeConnection(PoolEntry var1, String var2) throws java.sql.SQLException {
      ...
      try {
         ...
         if (this.poolState == 0) {
            if (var10.getCause() != null) {
               ...
               this.logger.debug((String)"{} - Cannot acquire connection from data source", (Object)this.poolName, (Object)var10);
            }
         }
      }
   ...
   private void abortActiveConnections(ExecutorService var1) throws java.sql.SQLException {
   ...
   private boolean softEvictConnection(PoolEntry var1, String var2, boolean var3) throws java.sql.SQLException {
      var1.markEvicted();
      ...
      public void run() {
         try {
            ...
            if (var1 > 0L && HikariPool.this.config.getMinimumIdle() < HikariPool.this.config.getMaximumPoolSize()) {
               ...
               var5 = "After cleanup  ";
               List<PoolEntry> var6 = HikariPool.this.connectionBag.values(0);
