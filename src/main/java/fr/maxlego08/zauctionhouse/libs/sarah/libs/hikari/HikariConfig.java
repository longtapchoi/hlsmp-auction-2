...
public class HikariConfig implements HikariConfigMXBean {
   ...
   public void setHealthCheckRegistry(Object var1) {
      ...
      if (var1 != null) {
         var1 = this.getObjectOrPerformJndiLookup(var1);
         // HealthCheckRegistry check removed
      }
   ...
   private void logConfiguration() {
      ...
      for(String var3 : new java.util.TreeSet<>(PropertyElf.getPropertyNames(HikariConfig.class))) {
         try {
            ...
            LOGGER.debug("{}{}", var3 + "................................................".substring(0, 32), var4);
