      ...
      if ((long)var5.length != var6) {
         ...
         return (var2x) -> {
            ...
            for(int var4 = 0; var4 < var5.length; ++var4) {
               Field var5x = var5[var4];
               var5x.setAccessible(true);
               Class var6 = var5x.getType();
               String var7 = var5x.getName();
               String var8 = var6.getTypeName().substring(var6.getTypeName().lastIndexOf(46) + 1);
               Column var9 = null;
               ...
               if (var9 != null && var9.autoIncrement()) {
                  if (!var6.equals(Long.TYPE) && !var6.equals(Long.class)) {
                     if (!var6.equals(Integer.TYPE) && !var6.equals(Integer.class)) {
