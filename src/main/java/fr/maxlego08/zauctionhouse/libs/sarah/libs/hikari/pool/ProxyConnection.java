...
public abstract class ProxyConnection implements Connection {
   ...
   public void rollback(Savepoint var1) throws java.sql.SQLException {
      this.delegate.rollback(var1);
      this.isCommitStateDirty = false;
      this.lastAccess = ClockSource.currentTime();
   }

   public void setAutoCommit(boolean var1) throws java.sql.SQLException {
   ...
   public void setCatalog(String var1) throws java.sql.SQLException {
      this.delegate.setCatalog(var1);
      this.dbcatalog = var1;
      this.dirtyBits |= 8;
   }

   public void setNetworkTimeout(Executor var1, int var2) throws java.sql.SQLException {
      this.delegate.setNetworkTimeout(var1, var2);
      this.networkTimeout = var2;
      this.dirtyBits |= 16;
   }

   public void setSchema(String var1) throws java.sql.SQLException {
      this.delegate.setSchema(var1);
      this.dbschema = var1;
      this.dirtyBits |= 32;
   }

   public final boolean isWrapperFor(Class<?> var1) throws java.sql.SQLException {
