...
public class MigrationManager {
   ...
   public static void execute(DatabaseConnection var0, Logger var1) {
      ...
      schemas.forEach((var3) -> {
         if (!var2.contains(var3.getMigration().getClass().getSimpleName())) {
            ...
            ArrayList<fr.maxlego08.zauctionhouse.libs.sarah.conditions.ColumnDefinition> var22 = new ArrayList<>();
                     ...
                     try {
                        ...
                        try {
                           while(var28.next()) {
                              ...
                              var27.removeIf((var1x) -> ((fr.maxlego08.zauctionhouse.libs.sarah.database.Migration)var1x).getClass().getSimpleName().equals(var10));
                           }
            ...
            try {
               int var25 = SchemaBuilder.alter((Migration)null, var5, (Consumer<fr.maxlego08.zauctionhouse.libs.sarah.database.Schema>)((var1x) -> {
                  for(fr.maxlego08.zauctionhouse.libs.sarah.conditions.ColumnDefinition var3c : var22) {
                     var1x.addColumn(var3c).nullable();
                  }
   ...
   private static void createMigrationTable(DatabaseConnection var0, Logger var1) {
      Schema var2 = SchemaBuilder.create((Migration)null, migrationTableName, (Consumer<fr.maxlego08.zauctionhouse.libs.sarah.database.Schema>)((var0x) -> {
