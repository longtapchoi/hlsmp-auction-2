...
public final class PropertyElf {
   ...
   private static void setProperty(Object var0, String var1, Object var2, List<Method> var3) {
      ...
      Method var6 = (Method)var3.stream().filter((var1x) -> var1x.getName().equals(var5) && var1x.getParameterCount() == 1).findFirst().orElse(null);
      if (var6 == null) {
         String var7 = "set" + var1.toUpperCase(Locale.ENGLISH);
         var6 = (Method)var3.stream().filter((var1x) -> var1x.getName().equals(var7) && var1x.getParameterCount() == 1).findFirst().orElse(null);
      }

      if (var6 == null) {
         var4.error("Property {} does not exist on target {}", var1, var0.getClass());
