...
final class PoolEntry implements ConcurrentBag.IConcurrentBagEntry {
   ...
   void setFutureEol(ScheduledFuture<?> var1) throws java.sql.SQLException {
      this.endOfLife = var1;
   }

   public void setKeepalive(ScheduledFuture<?> var1) throws java.sql.SQLException {
      this.keepalive = var1;
   }

   Connection createProxyConnection(ProxyLeakTask var1, long var2) throws java.sql.SQLException {
   ...
   void resetConnectionState(ProxyConnection var1, int var2) throws java.sql.SQLException {
   ...
   public void setState(int var1) throws java.sql.SQLException {
