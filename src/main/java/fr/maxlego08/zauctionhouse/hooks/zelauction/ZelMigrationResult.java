...
public class ZelMigrationResult {
   ...
   private ZelMigrationResult(boolean var1, int var2, int var3, int var4, int var5, long var6, String var8) {
      this.success = var1;
   ...
   public static ZelMigrationResult success(int var0, int var1, int var2, int var3, long var4) {
      return new ZelMigrationResult(true, var0, var1, var2, var3, var4, (String)null);
   }

   public static ZelMigrationResult failure(String var0) {
      return new ZelMigrationResult(false, 0, 0, 0, 0, 0L, var0);
   }
