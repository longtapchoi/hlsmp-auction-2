...
public class Serialize {
   public static String serialize(ItemStack var0, AuctionPlugin var1, boolean var2) {
      if (var0 == null) {
         ...
         try {
            Map<String, Object> var13 = var0.serialize();
            YamlConfiguration var14 = new YamlConfiguration();

            for(Map.Entry<String, Object> var6 : var13.entrySet()) {
               var14.set(var6.getKey(), var6.getValue());
            }
   ...
   public static String serializeModern(ItemStack var0, AuctionPlugin var1) {
      if (var0 == null) {
         ...
         try {
            Map<String, Object> var2 = var0.serialize();
            YamlConfiguration var3 = new YamlConfiguration();

            for(Map.Entry<String, Object> var5 : var2.entrySet()) {
               var3.set(var5.getKey(), var5.getValue());
            }
