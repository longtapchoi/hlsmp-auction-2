...
public class SearchService {
   ...
   public IntList search(SortedItemsCache var1, String var2, SortItem var3, Category var4) {
      ...
      if (var5.value().isEmpty()) {
         ...
         List var8 = this.plugin.getAuctionManager().getItems(StorageType.LISTED);
         ...
         for(int var12 : var6) {
            Item var13 = (Item)var9.get(var12);
            if (var13 != null) {
               if (var5.isDefault()) {
