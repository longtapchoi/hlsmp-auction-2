...
public class SortButton extends Button {
   ...
   public ItemStack getCustomItemStack(@NotNull Player var1, boolean var2, @NotNull Placeholders var3) {
      ...
      this.sortItems.forEach((var4x) -> {
         SortItem var5x = var5.get(PlayerCacheKey.ITEM_SORT, var4.defaultSort());
         var3.register(var4x.name(), (var4x == var5x ? this.enableText : this.disableText).replace("%sorting%", var4.sortItems().get(var4x)));
      });
   ...
   public void onClick(@NonNull Player var1, @NonNull InventoryClickEvent var2, @NonNull InventoryEngine var3, int var4, @NonNull Placeholders var5) {
      ...
      if (!Boolean.TRUE.equals(var7.get(PlayerCacheKey.ITEM_SORT_LOADING))) {
         if (!this.sortItems.isEmpty()) {
            SortItem var8 = var7.get(PlayerCacheKey.ITEM_SORT, var6.defaultSort());
            ...
            if (var9 != -1) {
               ...
               SortItem var13 = this.sortItems.get(var12);
               ...
               this.plugin.getScheduler().runAsync((var4x) -> {
                  ...
                  this.plugin.getScheduler().runAtEntity(var1, (var3z) -> {
