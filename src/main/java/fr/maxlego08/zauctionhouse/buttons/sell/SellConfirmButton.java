...
public class SellConfirmButton extends Button {
   ...
   public void onClick(@NonNull Player var1, @NonNull InventoryClickEvent var2, @NonNull InventoryEngine var3, int var4, @NonNull Placeholders var5) {
      ...
      Object var8 = (Map)var7.get(PlayerCacheKey.SELL_ITEMS);
      if (var8 == null || ((Map)var8).isEmpty()) {
         ...
         var8 = new HashMap();
         ((Map)var8).put(-1, var9.clone());
      }

      BigDecimal var14 = (BigDecimal)var7.get(PlayerCacheKey.SELL_PRICE, BigDecimal.ZERO);
      ...
      if (var10 == null) {
         ...
         long var12 = (Long)var7.get(PlayerCacheKey.SELL_EXPIRED_AT, 0L);
         var7.set(PlayerCacheKey.CURRENT_PAGE, 1);
         var7.remove(PlayerCacheKey.SELL_ITEMS);
         var1.closeInventory();
         var6.getSellService().sellAuctionItems(var1, var14, var12, (Map)var8, var11);
      }
   }
   ...
   private void createPlaceholders(Placeholders var1, Player var2) {
      ...
      BigDecimal var6 = (BigDecimal)var4.get(PlayerCacheKey.SELL_PRICE, BigDecimal.ZERO);
      AuctionEconomy var7 = var5.getDefaultEconomy(ItemType.AUCTION);
      AuctionEconomy var8 = var7 != null ? (AuctionEconomy)var4.get(PlayerCacheKey.SELL_ECONOMY, var7) : null;
      Map var9 = (Map)var4.get(PlayerCacheKey.SELL_ITEMS);
      int var10 = 0;
      int var11 = 0;
      ...
      if (var8 != null) {
         var1.register("price", var5.format((AuctionEconomy)var8, var6));
