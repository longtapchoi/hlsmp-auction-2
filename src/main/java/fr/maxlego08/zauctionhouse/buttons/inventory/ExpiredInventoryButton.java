...
public class ExpiredInventoryButton extends Button {
   ...
   public ExpiredInventoryButton(Plugin var1) {
   ...
   public boolean checkPermission(Player var1, InventoryEngine var2, Placeholders var3) {
      List var4 = this.plugin.getAuctionManager().getExpiredItems(var1);
   ...
   public void onClick(Player var1, InventoryClickEvent var2, InventoryEngine var3, int var4, Placeholders var5) {
      ...
      this.plugin.getInventoriesLoader().openInventory(var1, Inventories.EXPIRED_ITEMS);
   }

   public ItemStack getCustomItemStack(@NotNull Player var1, boolean var2, @NotNull Placeholders var3) {
      List var4 = this.plugin.getAuctionManager().getExpiredItems(var1);
      var3.register("expired-items", String.valueOf(var4.size()));
