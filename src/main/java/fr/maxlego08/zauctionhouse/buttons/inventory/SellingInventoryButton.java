...
public class SellingInventoryButton extends Button {
   ...
   public SellingInventoryButton(Plugin var1) {
   ...
   public boolean checkPermission(Player var1, InventoryEngine var2, Placeholders var3) {
      List var4 = this.plugin.getAuctionManager().getPlayerSellingItems(var1);
   ...
   public void onClick(@NonNull Player var1, @NonNull InventoryClickEvent var2, @NonNull InventoryEngine var3, int var4, @NonNull Placeholders var5) {
      ...
      this.plugin.getInventoriesLoader().openInventory(var1, Inventories.SELLING_ITEMS);
   }

   public ItemStack getCustomItemStack(@NonNull Player var1, boolean var2, @NotNull Placeholders var3) {
      List var4 = this.plugin.getAuctionManager().getPlayerSellingItems(var1);
      var3.register("selling-items", String.valueOf(var4.size()));
