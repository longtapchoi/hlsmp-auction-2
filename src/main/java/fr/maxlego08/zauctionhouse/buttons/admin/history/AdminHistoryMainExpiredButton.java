...
public class AdminHistoryMainExpiredButton extends TargetHelper {
   public AdminHistoryMainExpiredButton(Plugin var1) {
   ...
   public @Nullable ItemStack getCustomItemStack(@NotNull Player var1, boolean var2, @NotNull Placeholders var3) {
      ...
      this.getTargetUniqueId(var1).ifPresent((var2x) -> {
         List var3x = this.plugin.getAuctionManager().getExpiredItems(var2x);
         var3.register("expired-items", String.valueOf(var3x.size()));
   ...
   public void onClick(@NotNull Player var1, @NotNull InventoryClickEvent var2, @NotNull InventoryEngine var3, int var4, @NotNull Placeholders var5) {
      this.plugin.getInventoriesLoader().openInventory(var1, Inventories.ADMIN_EXPIRED_ITEMS);
   }
}
