...
public class TransactionDateFilterButton extends Button {
   ...
   public TransactionDateFilterButton(AuctionPlugin var1, String var2, String var3, List<DateFilter> var4, Map<DateFilter, String> var5) {
      this.plugin = var1;
   ...
   public ItemStack getCustomItemStack(@NotNull Player var1, boolean var2, @NotNull Placeholders var3) {
      ...
      DateFilter var5 = (DateFilter)var4.get(PlayerCacheKey.ADMIN_TRANSACTIONS_DATE_FILTER, DateFilter.ALL);
   ...
   public void onClick(@NonNull Player var1, @NonNull InventoryClickEvent var2, @NonNull InventoryEngine var3, int var4, @NonNull Placeholders var5) {
      ...
      if (!this.dateFilters.isEmpty()) {
         ...
         DateFilter var7 = (DateFilter)var6.get(PlayerCacheKey.ADMIN_TRANSACTIONS_DATE_FILTER, DateFilter.ALL);
         ...
         var6.set(PlayerCacheKey.ADMIN_TRANSACTIONS_DATE_FILTER, var12);
