...
public class CombinedItemsButton extends PaginateButton {
   ...
   public void onRender(Player var1, InventoryEngine var2) {
      List<Item> var3 = this.getCombinedItems(var1);
      if (var3.isEmpty()) {
         if (this.emptySlot != -1) {
         ...
         this.paginate(var3, var2, (var5x, var6x) -> {
            ...
            List<String> var8 = this.getLoreForStorageType(var4, var6x, var7);
            Set<fr.maxlego08.zauctionhouse.api.item.ItemPlaceholder> var9 = this.getPlaceholdersForStorageType(var4, var6x, var7);
   ...
   private Set<ItemPlaceholder> getPlaceholdersForStorageType(ItemLoreConfiguration var1, Item var2, StorageType var3) {
      Set<fr.maxlego08.zauctionhouse.api.item.ItemPlaceholder> var10000;
      switch (var3) {
