...
public class SellingItemsButton extends PaginateButton {
   ...
   public void onRender(Player var1, InventoryEngine var2) {
      ...
      List<? extends fr.maxlego08.zauctionhouse.api.item.Item> var4 = var3.getPlayerSellingItems(var1);
      if (var4.isEmpty()) {
         if (this.emptySlot != -1) {
         ...
         List<String> var6 = var5.sellingLore();
         List<String> var7 = var5.beingPurchasedLore();
         Set<fr.maxlego08.zauctionhouse.api.item.ItemPlaceholder> var8 = var5.sellingPlaceholders();
         Set<fr.maxlego08.zauctionhouse.api.item.ItemPlaceholder> var9 = var5.beingPurchasedPlaceholders();
         this.paginate(var4, var2, (var7x, var8x) -> {
            boolean var9x = var8x.getStatus() == ItemStatus.AVAILABLE;
            var2.addItem(var7x, var8x.buildItemStack(var1, var9x ? var6 : var7, var9x ? var8 : var9)).setClick((var3z) -> this.plugin.getAuctionManager().getRemoveService().removeSellingItem(var1, var8x));
         });
      }
   }
