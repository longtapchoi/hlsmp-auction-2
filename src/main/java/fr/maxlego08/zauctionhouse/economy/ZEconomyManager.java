...
public class ZEconomyManager implements EconomyManager {
                              ...
                              if (var14 == null) {
                                 ...
                                 if (var15 == null) {
                                    ...
                                    switch (var15) {
                                       case ITEM:
                                       case ZMENUITEMS:
                                          Object var21 = var2.getObject("item");
                                          if (var21 == null) {
                                             this.plugin.getLogger().severe("Economy '" + var3 + "' is active but doesn’t have an item, please correct that!");
                                             var10000 = null;
                                          } else {
                                             MenuItemStack var18 = this.plugin.getInventoriesLoader().getInventoryManager().loadItemStack(var1, "economies", (Map)var21);
                                             var10000 = new ZMenuItemProvider(this.plugin, var18);
                                          }
                                          break;
   ...
   private EnumMap<ItemType, BigDecimal> loadPrices(Object var1, String var2) {
      EnumMap<ItemType, BigDecimal> var3 = new EnumMap<>(ItemType.class);
      if (var1 instanceof Number var4) {
         for(ItemType var9 : ItemType.values()) {
            var3.put(var9, this.toBigDecimal(var4));
         }
      } else if (var1 instanceof Map var5m) {
         var5m.forEach((var3x, var4x) -> {
            if (var3x instanceof String var5s) {
               if (var4x instanceof Number var6) {
                  ItemType var7 = ItemType.valueOf(var5s.toUpperCase());
