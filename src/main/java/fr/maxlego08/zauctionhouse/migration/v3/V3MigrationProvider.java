...
public class V3MigrationProvider implements MigrationProvider {
      ...
      if (var1 == null) {
         ...
         switch (var1.getString("source-type", "SQLITE").toUpperCase()) {
            ...
            case "MARIADB":
               ...
               break;
            default:
               var10000 = "Unknown source type: " + var2;
         }
   ...
   public CompletableFuture<MigrationResult> migrate(AuctionPlugin var1, ConfigurationSection var2, MigrationCallback var3) {
      ...
      return var6.thenApply((var0) -> MigrationResult.success(var0.getPlayersImported(), var0.getItemsImported(), var0.getTransactionsImported(), var0.getErrors(), var0.getDurationMs())).exceptionally((var0) -> MigrationResult.failure(var0.getMessage()));
   }
}
