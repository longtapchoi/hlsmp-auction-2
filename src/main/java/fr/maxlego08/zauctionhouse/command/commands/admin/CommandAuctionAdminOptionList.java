...
public class CommandAuctionAdminOptionList extends VCommand {
   public CommandAuctionAdminOptionList(AuctionPlugin var1) {
      super(var1);
   ...
   protected CommandType perform(AuctionPlugin var1) {
      ...
      if (var2 == null) {
         ...
         if (var3 == null) {
            ...
            Map var4 = this.auctionManager.getOptionService().getPlayerOptions(var3.getUniqueId());
            this.message(var1, this.sender, Message.ADMIN_OPTION_LIST_HEADER, new Object[]{"%player%", var3.getName()});

            for(PlayerOption var8 : PlayerOption.values()) {
               String var9 = (String)var4.getOrDefault(var8, var8.getDefaultValue());
               this.message(var1, this.sender, Message.OPTION_LIST_ENTRY, new Object[]{"%option%", var8.getKey(), "%value%", var9});
            }
