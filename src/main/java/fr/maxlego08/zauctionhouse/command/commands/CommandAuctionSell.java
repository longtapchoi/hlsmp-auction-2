...
public class CommandAuctionSell extends VCommandArgument<CommandSellArguments> {
   ...
   public void createCommandArguments(AuctionPlugin var1, Class<CommandSellArguments> var2) {
      this.forEachArgument("commands.sell.", (var0) -> (var1a, var2a) -> var0.autoCompletion().stream().map((var1x) -> {
               if (var1x.contains("%max-stack-size%") && var1a instanceof Player var2b) {
                  ItemStack var3 = var2b.getInventory().getItemInMainHand();
      ...
      if (var5.getType().isAir() && !var1.getConfiguration().isSellInventoryEnabled()) {
         ...
         if (var7 == null) {
            ...
            if (var8 == null) {
               ...
               Optional<AuctionEconomy> var9 = var2.getEconomy(var8);
               if (var9.isEmpty()) {
                  ...
                  if (var11 == null) {
                     ...
                     if (!var16.callEvent()) {
                        ...
                        Map<Integer, ItemStack> var18 = Map.of(-1, var17);
