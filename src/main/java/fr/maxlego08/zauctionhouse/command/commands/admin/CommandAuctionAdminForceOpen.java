   ...
   protected CommandType perform(AuctionPlugin var1) {
      ...
      if (var2 == null) {
         ...
         if (var5 == null) {
            ...
            final int var4Final = var4;
            final Inventories var5Final = var5;
            this.plugin.getScheduler().runAtEntity(var2, (var4x) -> this.plugin.getInventoriesLoader().openInventory(var2, var5Final, var4Final));
