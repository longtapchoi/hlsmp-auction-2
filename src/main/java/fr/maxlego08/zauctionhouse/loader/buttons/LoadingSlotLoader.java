...
public class LoadingSlotLoader extends ButtonLoader {
   ...
   public LoadingSlotLoader(@NotNull Plugin var1, @NotNull Class<? extends Button> var2, String var3) {
      super(var1, var3);
      this.clazz = var2;
   }
   ...
   public @Nullable Button load(@NonNull YamlConfiguration var1, @NonNull String var2, @NonNull DefaultButtonValue var3) {
      try {
         int var4 = var1.getInt(var2 + "loading-slot", 0);
         if (var4 < 0 && var4 > var3.getInventorySize() && var4 != -1) {
            Logger var8 = this.plugin.getLogger();
            String var9 = this.clazz.getSimpleName();
            var8.severe("Invalid slot for loading button " + var9 + ": " + var4 + ". It must be a multiple of 9 or -1");
            return null;
         } else {
