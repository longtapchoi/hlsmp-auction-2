...
public class TransactionDateFilterLoader extends ButtonLoader {
   private final AuctionPlugin plugin;

   public TransactionDateFilterLoader(AuctionPlugin var1) {
      super(var1, "ZAUCTIONHOUSE_ADMIN_TRANSACTIONS_FILTER_DATE");
      this.plugin = var1;
   }
   ...
   public Button load(YamlConfiguration var1, String var2, DefaultButtonValue var3) {
      ...
      return new TransactionDateFilterButton(this.plugin, var4, var5, var6, var15);
   }
}
