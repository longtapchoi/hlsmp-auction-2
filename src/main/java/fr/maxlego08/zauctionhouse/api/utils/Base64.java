      ...
      if (var0 == null) {
         ...
         if (var1 == 0) {
            ...
            for(int var13 = 0; var13 < var3; ++var13) {
               ...
               var7 = (byte)(var9 & 15);
               var6 = (byte)(var8 & 3);
               byte var14 = (var8 & -128) == 0 ? (byte)((var8 >> 2) & 0xff) : (byte)(var8 >> 2 ^ 192);
               byte var15 = (var9 & -128) == 0 ? (byte)((var9 >> 4) & 0xff) : (byte)(var9 >> 4 ^ 240);
               byte var16 = (var10 & -128) == 0 ? (byte)((var10 >> 6) & 0xff) : (byte)(var10 >> 6 ^ 252);
               var17[var11++] = lookUpBase64Alphabet[var14];
               var17[var11++] = lookUpBase64Alphabet[(var15 | var6 << 4) & 0x3f];
               var17[var11++] = lookUpBase64Alphabet[(var7 << 2 | var16) & 0x3f];
            ...
            if (var2 == 8) {
               var8 = var0[var12];
               var6 = (byte)(var8 & 3);
               byte var42 = (var8 & -128) == 0 ? (byte)((var8 >> 2) & 0xff) : (byte)(var8 >> 2 ^ 192);
               ...
               var7 = (byte)(var9 & 15);
               var6 = (byte)(var8 & 3);
               byte var43 = (var8 & -128) == 0 ? (byte)((var8 >> 2) & 0xff) : (byte)(var8 >> 2 ^ 192);
               byte var44 = (var9 & -128) == 0 ? (byte)((var9 >> 4) & 0xff) : (byte)(var9 >> 4 ^ 240);
               var17[var11++] = lookUpBase64Alphabet[var43];
               var17[var11++] = lookUpBase64Alphabet[(var44 | var6 << 4) & 0x3f];
         ...
         if (var2 % 4 != 0) {
            ...
            if (var3 == 0) {
               ...
               for(var17 = new byte[var3 * 3]; var13 < var3 - 1; ++var13) {
                  ...
                  var17[var14++] = (byte)((var5 << 2 | var6 >> 4) & 0xff);
                  var17[var14++] = (byte)(((var6 & 15) << 4 | var7 >> 2 & 15) & 0xff);
                  var17[var14++] = (byte)((var7 << 6 | var8) & 0xff);
               }
               ...
               if (isData(var9 = var1[var15++]) && isData(var10 = var1[var15++])) {
                  ...
                  if (isData(var11) && isData(var12)) {
                     ...
                     if ((var6 & 15) != 0) {
                        ...
                        var48[var14] = (byte)((var5 << 2 | var6 >> 4) & 0xff);
                        return var48;
                     }
                  } else if (!isPad(var11) && isPad(var12)) {
                     var7 = base64Alphabet[var11];
                     if ((var7 & 3) != 0) {
                        ...
                        var16[var14++] = (byte)((var5 << 2 | var6 >> 4) & 0xff);
                        var16[var14] = (byte)(((var6 & 15) << 4 | var7 >> 2 & 15) & 0xff);
                        return var16;
                     }
                  } else {
                     return null;
