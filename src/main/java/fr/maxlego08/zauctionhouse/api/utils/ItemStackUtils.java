...
public class ItemStackUtils {
   ...
   public static ItemStack tryDeserializeItemStack(String var0) {
      try {
         ...
         DataInputStream var7 = new DataInputStream(new BufferedInputStream(new java.util.zip.GZIPInputStream(var1)));
         Object var4 = ItemStackUtils.EnumReflectionItemStack.NBTCOMPRESSEDSTREAMTOOLS.getClassz().getMethod("a", java.io.DataInput.class).invoke((Object)null, var7);
         ...
         throw new RuntimeException("Failed to deserialize ItemStack", var8);
      }
   }
