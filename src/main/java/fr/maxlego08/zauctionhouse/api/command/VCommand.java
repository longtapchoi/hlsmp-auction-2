...
public abstract class VCommand extends Arguments {
   ...
   public Optional<CollectionBiConsumer> getCompletionAt(int var1) {
      return Optional.ofNullable((CollectionBiConsumer)this.tabCompletions.getOrDefault(var1, (Object)null));
   }
   ...
   public List<String> toTab(AuctionPlugin var1, CommandSender var2, String[] var3) {
      ...
      Optional var5 = this.getCompletionAt(var4);
      if (var5.isPresent()) {
         CollectionBiConsumer var6 = (CollectionBiConsumer)var5.get();
