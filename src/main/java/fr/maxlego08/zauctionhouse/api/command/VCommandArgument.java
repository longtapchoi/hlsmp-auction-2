...
public abstract class VCommandArgument<T extends Enum<T>> extends VCommand {
   ...
   protected void populateIndexes() {
      for(Enum var4 : (Enum[])this.enumClass.getEnumConstants()) {
   ...
   protected void forEachArgument(String var1, Function<CommandArgumentConfiguration<T>, CollectionBiConsumer> var2) {
      ...
      for(int var5 = 0; var5 != var4.size(); ++var5) {
         CommandArgumentConfiguration var6 = (CommandArgumentConfiguration)var4.get(var5);
         this.argumentIndexes.put(var6.name(), var5);
         this.argumentDefaultValues.put(var6.name(), var6.defaultValue());
         CollectionBiConsumer var7 = (CollectionBiConsumer)var2.apply(var6);
         if (var6.required()) {
   ...
   protected String argAsString(T var1) {
      return this.argAsString(var1, (String)this.argumentDefaultValues.getOrDefault(var1, (Object)null));
   }

   protected String argAsString(T var1, String var2) {
      return this.argAsString((Integer)this.argumentIndexes.get(var1), var2);
   }
   ...
   protected boolean argAsBoolean(T var1) {
      ...
      try {
         var2 = Boolean.parseBoolean((String)this.argumentDefaultValues.getOrDefault(var1, "false"));
   ...
   protected boolean argAsBoolean(T var1, boolean var2) {
      return this.argAsBoolean((Integer)this.argumentIndexes.get(var1), var2);
   }
   ...
   protected int argAsInteger(T var1) {
      ...
      try {
         var2 = Integer.parseInt((String)this.argumentDefaultValues.getOrDefault(var1, "0"));
      } catch (Exception var4) {
      }
   ...
   protected int argAsInteger(T var1, int var2) {
      return this.argAsInteger((Integer)this.argumentIndexes.get(var1), var2);
   }
   ...
   protected double argAsDouble(T var1) {
      ...
      try {
         var2 = Double.parseDouble((String)this.argumentDefaultValues.getOrDefault(var1, "0.0"));
   ...
   protected double argAsDouble(T var1, double var2) {
      return this.argAsDouble((Integer)this.argumentIndexes.get(var1), var2);
   }
   ...
   protected long argAsLong(T var1) {
      ...
      try {
         var2 = Long.parseLong((String)this.argumentDefaultValues.getOrDefault(var1, "0"));
      } catch (Exception var5) {
      }
   ...
   protected long argAsLong(T var1, long var2) {
      return this.argAsLong((Integer)this.argumentIndexes.get(var1), var2);
   }

   protected Player argAsPlayer(T var1) {
      return this.argAsPlayer((Integer)this.argumentIndexes.get(var1));
   }

   protected Player argAsPlayer(T var1, Player var2) {
      return this.argAsPlayer((Integer)this.argumentIndexes.get(var1), var2);
   }

   protected OfflinePlayer argAsOfflinePlayer(T var1) {
      return this.argAsOfflinePlayer((Integer)this.argumentIndexes.get(var1));
   }

   protected OfflinePlayer argAsOfflinePlayer(T var1, OfflinePlayer var2) {
      return this.argAsOfflinePlayer((Integer)this.argumentIndexes.get(var1), var2);
   }
}
