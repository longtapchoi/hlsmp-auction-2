...
public class ItemRepository extends Repository {
   ...
   public void updateItems(Map<StorageType, List<Item>> var1) {
      for(Map.Entry<StorageType, List<? extends fr.maxlego08.zauctionhouse.api.item.Item>> var3 : var1.entrySet()) {
         StorageType var4 = var3.getKey();
         List<? extends fr.maxlego08.zauctionhouse.api.item.Item> var5 = var3.getValue();
         if (!var5.isEmpty()) {
            for(Item var7 : var5) {
